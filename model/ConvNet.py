...
class CNN(nn.Module):
    def __init__(self, p=0.5, channels=3, num_class=100, gpu_id=0, embedding_dim=128):
        ...
        self.conv3c = weight_norm(nn.Conv2d(256, embedding_dim, kernel_size=1, stride=1, padding=0, bias=False))
        self.bn3c = nn.BatchNorm2d(embedding_dim)
